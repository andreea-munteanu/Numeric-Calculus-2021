...
def check_diagonal(diagonal) -> bool:
    """
    Method for checking whether the main diagonal (represented as a vector) has strictly non-zero values.

    :param diagonal: input vector representing the main diagonal
    :return: true if diagonal is all non-zero, false otherwise
    """
